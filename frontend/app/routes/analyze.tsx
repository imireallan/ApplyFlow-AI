          ...
          <AnimatePresence mode="wait">
            {isSearching ? (
              ...
              <div className="p-12 text-center">
                <p className="text-sm font-bold text-gray-400">No relevant matches found.</p>
              </div>
            ) : (
              <div className="p-12 text-center opacity-40">
                <SearchIcon size={32} className="mx-auto mb-4 text-gray-300" />
            ...
            >
              ...
              <section className="space-y-6">
                ...
                <div className="p-8 md:p-12 bg-white rounded-[3rem] border border-gray-100 shadow-sm text-gray-700 leading-relaxed relative overflow-hidden">
                  ...
                  <span className="hidden md:block absolute top-8 left-8 text-6xl text-blue-50/80 font-serif leading-none">“</span>
                  
                  <p className="relative z-10 text-lg md:text-xl font-medium text-gray-600 italic md:px-8">
                    {selectedMatch.content}
                  </p>
                  
                  <span className="hidden md:block absolute bottom-8 right-8 text-6xl text-blue-50/80 font-serif leading-none rotate-180">“</span>
              ...
              {hasSearched && !isSearching ? (
                <div className="space-y-6">
                  ...
                  <div className="space-y-2">
                    <h2 className="text-xl font-black text-gray-900 tracking-tight">Select a Match</h2>
                    <p className="text-sm text-gray-400 max-w-[280px] mx-auto leading-relaxed">
                      We found relevant experience in your CV. Click a card on the left to analyze the match context.
                    </p>
                  </div>
                </div>
              ) : (
                <div className="space-y-4 opacity-30">
                  <SearchIcon size={64} strokeWidth={1} className="mx-auto text-gray-400" />
